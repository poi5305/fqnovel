...
function dbsearch($table,$array,$order="ORDER BY `id` DESC"){
	$query_set="";
	...
	$query = "SELECT * FROM `{$table}` WHERE ".$query_set." ".$order;
	//echo $query;
