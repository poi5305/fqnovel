...
cl.account.showList = function(){
	...
	db.sel(function(r){
		...
		for(var i=0; i<r.rows.length;i++){
			...
			html+=(r.rows.item(i).money /localStorage.currencyValue).toFixed(2)+localStorage.currencyName;
			html+="</div>";
...
cl.currency.update = function(){
	...
	$.getJSON("http://www.fqstory.jjvk.com/fqnovel/currency.php?code=zaxscdvf&jsoncallback=?",function(json) {
